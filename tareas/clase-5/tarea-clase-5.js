...
2. Los demás elementos usan .innerText para acceder y
 modificar al texto que aparece dentro.
...
$botonCalcular.onclick = function () {
    ...
    const sueldoMensual = calcularSalarioAnual(sueldoAnual);
...
// creá un formulario que capture el primer nombre, segundo nombre, apellido/s
//y edad del usuario, también vamos a crear un <h1> que diga Bienvenido!
